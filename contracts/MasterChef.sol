...
contract MasterChef is Ownable2StepUpgradeable, ReentrancyGuard {
    ...
    function initialize(IERC20Mintable _rewardToken,uint256 _rewardPerBlock,uint256 _startBlock) external initializer {
